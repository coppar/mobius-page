...
$('#containerBox').on('click', 'input[name$="goButton"]', function () {
        ...
        if(previousStartTime != '' && previousgoDuration != '' && previousgoMinutes != ''){            ClickedOnMoveButtonForFirstTime = 0;
...
function displaySubmitFormOverlay() {
    ...
    if(titleOfResourceTbInputed && categoryOfResourceTbInputed && UpdateOrDuplicateLessonPlanChosen){
